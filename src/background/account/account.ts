...
import {
  peakSavedWalletState,
  WalletStore,
} from '@/background/wallet/persistence';
import { Wallet } from '@/background/wallet/wallet';
import {
  BrowserStorage,
  clearStorageArtefacts,
  SessionStorage,
} from '@/background/webapis/storage';
import { getSHA256HexDigest } from '@/modules/crypto/get-sha256-hex-digest';
import { createCryptoKey, createSalt } from '@/modules/crypto/key';
import { sha256 } from '@/modules/crypto/sha256';
import { currentUserKey, getCurrentUser } from '@/shared/get-current-user';
import type { Passkey, User } from '@/shared/types/User';
import { validate } from '@/shared/validation/user-input';
