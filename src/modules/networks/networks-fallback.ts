...
const networksTestnetFallbackInfo: NetworkConfig[] = [
  {
    id: 'sepolia',
    name: 'Sepolia',
    ...
    rpc_url_internal: 'https://ethereum-sepolia-rpc.publicnode.com',
    rpc_url_public: [
    ...
    explorer_token_url: 'https://sepolia.etherscan.io/token/{ADDRESS}',
    explorer_address_url: 'https://sepolia.etherscan.io/address/{ADDRESS}',
    explorer_tx_url: 'https://sepolia.etherscan.io/tx/{HASH}',
    explorer_home_url: 'https://sepolia.etherscan.io',
  ...
  },
  {
    ...
    rpc_url_internal: 'https://api.devnet.solana.com',
    rpc_url_public: ['https://api.devnet.solana.com'],
    explorer_name: 'Solana Explorer',
    explorer_token_url:
      'https://explorer.solana.com/address/{ADDRESS}?cluster=devnet',
    explorer_address_url:
      'https://explorer.solana.com/address/{ADDRESS}?cluster=devnet',
    explorer_tx_url: 'https://explorer.solana.com/tx/{HASH}?cluster=devnet',
    explorer_home_url: 'https://explorer.solana.com/?cluster=devnet',
  ...
  },
  {
    id: 'ink-sepolia',
    name: 'Ink Sepolia',
    icon_url: 'https://chain-icons.s3.us-east-1.amazonaws.com/ink.png',
    is_testnet: true,
    standard: 'eip155',
    specification: {
      eip155: {
    ...
    wrapped_native_asset: null,
    rpc_url_internal: 'https://rpc-gel-sepolia.inkonchain.com',
    rpc_url_public: [
      'https://rpc-gel-sepolia.inkonchain.com',
      'https://ink-sepolia.drpc.org',
    ],
    explorer_name: 'Ink Sepolia Explorer',
    explorer_token_url:
      'https://explorer-sepolia.inkonchain.com/token/{ADDRESS}',
    explorer_address_url:
      'https://explorer-sepolia.inkonchain.com/address/{ADDRESS}',
    explorer_tx_url: 'https://explorer-sepolia.inkonchain.com/tx/{HASH}',
    explorer_home_url: 'https://explorer-sepolia.inkonchain.com',
    explorer_urls: ['https://explorer-sepolia.inkonchain.com'],
    supports_sending: true,
    supports_trading: false,
    supports_bridging: false,
    supports_actions: true,
  ...
  },
  {
    id: 'monad-testnet',
    name: 'Monad Testnet',
    icon_url: 'https://chain-icons.s3.us-east-1.amazonaws.com/monad.png',
    is_testnet: true,
    standard: 'eip155',
    specification: {
      eip155: {
    ...
    wrapped_native_asset: null,
    rpc_url_internal: 'https://testnet-rpc.monad.xyz',
    rpc_url_public: [
      'https://testnet-rpc.monad.xyz',
      'https://monad-testnet.drpc.org',
    ],
    explorer_name: 'Monad Explorer',
    explorer_token_url: 'https://testnet.monadexplorer.com/token/{ADDRESS}',
    explorer_address_url: 'https://testnet.monadexplorer.com/address/{ADDRESS}',
    explorer_tx_url: 'https://testnet.monadexplorer.com/tx/{HASH}',
    explorer_home_url: 'https://testnet.monadexplorer.com',
    explorer_urls: ['https://testnet.monadexplorer.com'],
    supports_sending: true,
    supports_trading: false,
    supports_bridging: false,
    supports_actions: true,
  ...
  },
  {
    ...
    icon_url: 'https://chain-icons.s3.us-east-1.amazonaws.com/unichain.png',
    is_testnet: true,
    standard: 'eip155',
    specification: {
      eip155: {
    ...
    wrapped_native_asset: null,
    rpc_url_internal: 'https://sepolia.unichain.org',
    rpc_url_public: ['https://sepolia.unichain.org'],
    explorer_name: 'Uniscan',
    explorer_token_url: 'https://sepolia.uniscan.xyz/token/{ADDRESS}',
    explorer_address_url: 'https://sepolia.uniscan.xyz/address/{ADDRESS}',
    explorer_tx_url: 'https://sepolia.uniscan.xyz/tx/{HASH}',
    explorer_home_url: 'https://sepolia.uniscan.xyz',
    explorer_urls: ['https://sepolia.uniscan.xyz'],
    supports_sending: true,
    supports_trading: false,
    supports_bridging: false,
    supports_actions: true,
  ...
  },
  {
    id: 'moca-testnet',
    name: 'Moca Testnet',
    icon_url: 'http://static.mocachain.org/moca.svg',
    is_testnet: true,
    standard: 'eip155',
    specification: {
      eip155: {
    ...
    wrapped_native_asset: null,
    rpc_url_internal: 'https://testnet-rpc.mocachain.org',
    rpc_url_public: ['https://testnet-rpc.mocachain.org'],
    explorer_name: 'Moca Chain Scan',
    explorer_token_url: 'https://testnet-scan.mocachain.org/token/{ADDRESS}',
    explorer_address_url:
      'https://testnet-scan.mocachain.org/address/{ADDRESS}',
    explorer_tx_url: 'https://testnet-scan.mocachain.org/tx/{HASH}',
    explorer_home_url: 'https://testnet-scan.mocachain.org',
    explorer_urls: ['https://testnet-scan.mocachain.org'],
    supports_sending: true,
    supports_trading: false,
    supports_bridging: false,
    supports_actions: true,
...
const networksMainnetFallbackInfo: NetworkConfig[] = [
  {
    id: 'ethereum',
    name: 'Ethereum',
    icon_url: 'https://chain-icons.s3.amazonaws.com/ethereum.png',
  ...
  },
  {
    ...
    rpc_url_internal:
      'https://solana-mainnet.core.chainstack.com/bb2e2136e492bda62e186ea8cf2a5525',
    rpc_url_public: [
      'https://solana-mainnet.core.chainstack.com/bb2e2136e492bda62e186ea8cf2a5525',
    ],
...
export const networksFallbackInfo: NetworkConfig[] = [
  ...networksTestnetFallbackInfo,
  ...networksMainnetFallbackInfo,
];
